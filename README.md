...
<table width=100% valign=top >
  <tr>
    ...
    <td>python, pandas, numpy, scipy, matplotlib, seaborn, math, предобработка, EDA, визуализация данных, корреляционный анализ, проверка статистических гипотез, t-тест, тест тест Манна-Уитни</td>
      ...
      <tr>
    <td><a href="2. Анализ результатов A\B теста, приоритизация гипотез/Анализ результатов AB теста, приоритизация гипотез.ipynb">Анализ результатов AB теста, приоритизация гипотез</a></td>
